class AddAnimalTables < ActiveRecord::Migration[7.0]
  def change
    ...
    # add_column :sheeps, :license_year, :integer
    # add_column :sheeps, :district, :string
    # add_column :sheeps, :residency, :string
    # add_column :sheeps, :hunters, :integer
    # add_column :sheeps, :days, :integer
    # add_column :sheeps, :days_per_hunter, :integer
    # add_column :sheeps, :total_harvest, :integer
    # add_column :sheeps, :rams, :integer
    # add_column :sheeps, :ewes, :integer
    # add_column :sheeps, :lambs, :integer
    # add_column :sheeps, :location, :string
    # add_column :sheeps, :district_square_mileage, :integer
    # add_column :sheeps, :public_land_percentage, :decimal, :precision => 8, :scale => 4
    # add_column :sheeps, :harvested_rams_per_square_mile, :decimal, :precision => 12, :scale => 4
    # add_column :sheeps, :harvested_ewes_per_square_mile, :decimal, :precision => 12, :scale => 4
    # add_column :sheeps, :harvested_lambs_per_square_mile, :decimal, :precision => 12, :scale => 4
    # add_column :sheeps, :total_harvest_per_square_mile, :decimal, :precision => 12, :scale => 4
    ...
    # add_column :upland_game, :license_year, :integer
    # add_column :upland_game, :district, :string
    # add_column :upland_game, :residency, :string
    # add_column :upland_game, :species, :string
    # add_column :upland_game, :hunters, :integer
    # add_column :upland_game, :hunter_success_pct, :decimal, :precision => 8, :scale => 4
    # add_column :upland_game, :total_harvest, :integer
    # add_column :upland_game, :location, :string
    # add_column :upland_game, :district_square_mileage, :integer
    # add_column :upland_game, :total_harvest_per_square_mile, :decimal, :precision => 12, :scale => 4
